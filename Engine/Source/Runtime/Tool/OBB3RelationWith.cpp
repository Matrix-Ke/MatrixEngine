...
int VSOBB3::RelationWith(const Matrix::Math::VSVector3& Point) const
{
	return Point.RelationWith(*this);
}
/*----------------------------------------------------------------*/
int VSOBB3::RelationWith(const Line3& Line, unsigned int& Quantity, VSREAL& tNear, VSREAL& tFar) const
{

	return Line.RelationWith(*this, Quantity, tNear, tFar);
}
/*----------------------------------------------------------------*/
int VSOBB3::RelationWith(const Ray3& Ray, unsigned int& Quantity, VSREAL& tNear, VSREAL& tFar) const
{

	return Ray.RelationWith(*this, Quantity, tNear, tFar);
}
/*----------------------------------------------------------------*/
int VSOBB3::RelationWith(const Segment3& Segment, unsigned int& Quantity, VSREAL& tNear, VSREAL& tFar) const
{
	return Segment.RelationWith(*this, Quantity, tNear, tFar);
}
/*----------------------------------------------------------------*/
int VSOBB3::RelationWith(const Plane3& Plane) const
{
...
/*----------------------------------------------------------------*/
/*void VSOBB3::OBBProj(const VSOBB3 &OBB, const Matrix::Math::VSVector3 &vcV,
...
/*----------------------------------------------------------------*/
/*void VSOBB3::TriProj(const Matrix::Math::VSVector3 &v0, const Matrix::Math::VSVector3 &v1,
...
int VSOBB3::RelationWith(const VSTriangle3 & Triangle)const
{
	...
	VSREAL     fD_C;
	Matrix::Math::VSVector3 vcV, vcTriEdge[3], vcA[3];
...
/*----------------------------------------------------------------*/
int VSOBB3::RelationWith(const Rectangle3& Rectangle) const
{
...
int VSOBB3::RelationWith(const VSOBB3& OBB) const
{
	...
	Matrix::Math::VSVector3 vcD = OBB.m_Center - m_Center;
...
/*----------------------------------------------------------------*/
int VSOBB3::RelationWith(const Sphere3& Sphere) const
{
