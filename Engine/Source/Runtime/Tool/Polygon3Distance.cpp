...
VSREAL Polygon3::SquaredDistance(const Matrix::Math::VSVector3& Point, int& IndexTriangle, VSREAL fTriangleParameter[3]) const
{
...
VSREAL Polygon3::SquaredDistance(const VSTriangle3& Triangle,
	int& IndexTriangle,
...
VSREAL Polygon3::SquaredDistance(const VSOBB3& OBB, int& IndexTriangle,
	...
	Matrix::Math::VSVector3& TrianglePoint, Matrix::Math::VSVector3& PlanePoint) const
{
	...
	{
		TriangleTemp.Set(m_pPoint[m_pIndex[i]], m_pPoint[m_pIndex[i + 1]], m_pPoint[m_pIndex[i + 2]]);
		Matrix::Math::VSVector3 Point1, Point2;
