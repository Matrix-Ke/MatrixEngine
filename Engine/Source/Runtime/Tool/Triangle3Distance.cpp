...
/*----------------------------------------------------------------*/
VSREAL VSTriangle3::SquaredDistance(const Line3& Line, VSREAL fTriangleParameter[3], VSREAL& fLineParameter) const
{
...
/*----------------------------------------------------------------*/
//射线和三角形距离
VSREAL VSTriangle3::SquaredDistance(const Ray3& Ray, VSREAL fTriangleParameter[3], VSREAL& fRayParameter) const
{
	return Ray.SquaredDistance(*this, fRayParameter, fTriangleParameter);
}
/*----------------------------------------------------------------*/
//线段和三角形距离
VSREAL VSTriangle3::SquaredDistance(const Segment3& Segment, VSREAL fTriangleParameter[3], VSREAL& fSegmentParameter) const
{
	return Segment.SquaredDistance(*this, fSegmentParameter, fTriangleParameter);
}
/*----------------------------------------------------------------*/
//点和三角形距离
VSREAL VSTriangle3::SquaredDistance(const Matrix::Math::VSVector3& Point, VSREAL fTriangleParameter[3]) const
{
...
/*----------------------------------------------------------------*/
VSREAL VSTriangle3::SquaredDistance(const Rectangle3& Rectangle,
...
/*----------------------------------------------------------------*/
VSREAL VSTriangle3::Distance(const Sphere3& Sphere, VSREAL fTriangleParameter[3], Matrix::Math::VSVector3& SpherePoint) const
{
	return Sphere.Distance(*this, SpherePoint, fTriangleParameter);
}
/*----------------------------------------------------------------*/
VSREAL VSTriangle3::Distance(const Plane3& Plane, Matrix::Math::VSVector3& TrianglePoint, Matrix::Math::VSVector3& PlanePoint) const
{
	return Plane.Distance(*this, PlanePoint, TrianglePoint);
}
/*----------------------------------------------------------------*/
VSREAL VSTriangle3::SquaredDistance(const AABB3& AABB, VSREAL TriangleParameter[3], VSREAL AABBParameter[3]) const
{

	return AABB.SquaredDistance(*this, AABBParameter, TriangleParameter);
}
/*----------------------------------------------------------------*/
VSREAL VSTriangle3::SquaredDistance(const Polygon3& Polygon,
	VSREAL fTriangle1Parameter[3],
	int& IndexTriangle,
	VSREAL fTriangle2Parameter[3]) const
{
