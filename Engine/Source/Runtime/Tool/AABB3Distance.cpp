...
/*----------------------------------------------------------------*/
VSREAL AABB3::SquaredDistance(const Matrix::Math::VSVector3& Point, VSREAL fAABBParameter[3]) const
{
...
/*----------------------------------------------------------------*/
/*
void AABB3::Face (int i0, int i1, int i2, Matrix::Math::VSVector3 Pnt,
...
/*----------------------------------------------------------------*/
/*void AABB3::CaseNoZeros (Matrix::Math::VSVector3& Pnt,
...
/*----------------------------------------------------------------*/
/*void AABB3::Case0 (int i0, int i1, int i2, Matrix::Math::VSVector3& Pnt,
				   const Matrix::Math::VSVector3& Dir, VSREAL& rfSqrDistance,VSREAL &fLParam)const
{
...
/*----------------------------------------------------------------*/
/*void AABB3::Case00 (int i0, int i1, int i2,
...
/*----------------------------------------------------------------*/
/*void AABB3::Case000 (Matrix::Math::VSVector3& Pnt, VSREAL& rfSqrDistance)const
{
	VSREAL fDelta;
...
VSREAL AABB3::SquaredDistance(const Line3& Line, VSREAL fAABBParameter[3], VSREAL& fLineParameter) const
{
	...
	return fSqrDist;
	/*Matrix::Math::VSVector3 Orig = Line.GetOrig() - m_Center;
	Matrix::Math::VSVector3 Dir = Line.GetDir();
...
/*----------------------------------------------------------------*/
VSREAL AABB3::SquaredDistance(const VSTriangle3& Triangle, VSREAL AABBParameter[3],
...
/*----------------------------------------------------------------*/
VSREAL AABB3::Distance(const Plane3& Plane, Matrix::Math::VSVector3& AABBPoint, Matrix::Math::VSVector3& PlanePoint) const
{

	return Plane.Distance(*this, PlanePoint, AABBPoint);
}
/*----------------------------------------------------------------*/
VSREAL AABB3::Distance(const Sphere3& Sphere, VSREAL fAABBParameter[3], Matrix::Math::VSVector3& SpherePoint) const
{
