...
/*----------------------------------------------------------------*/
VSREAL VSOBB3::SquaredDistance(const Matrix::Math::VSVector3& Point, VSREAL fOBBParameter[3]) const
{
	Matrix::Math::VSVector3 Diff = Point - m_Center;
...
/*----------------------------------------------------------------*/
/*void VSOBB3::CaseNoZeros (Matrix::Math::VSVector3& Pnt,
						 const Matrix::Math::VSVector3& Dir, VSREAL& rfSqrDistance,VSREAL &fLParam)const
{
	Matrix::Math::VSVector3 kPmE(
		Pnt.x - m_fA[0],
		Pnt.y - m_fA[1],
		Pnt.z - m_fA[2]);
...
/*----------------------------------------------------------------*/
/*void VSOBB3::Case0 (int i0, int i1, int i2, Matrix::Math::VSVector3& Pnt,
				   const Matrix::Math::VSVector3& Dir, VSREAL& rfSqrDistance,VSREAL &fLParam)const
{
...
/*----------------------------------------------------------------*/
/*void VSOBB3::Case000 (Matrix::Math::VSVector3& Pnt, VSREAL& rfSqrDistance)const
{
	VSREAL fDelta;
...
/*----------------------------------------------------------------*/
VSREAL VSOBB3::SquaredDistance(const Line3& Line, VSREAL fOBBParameter[3], VSREAL& fLineParameter) const
{
...
/*----------------------------------------------------------------*/
VSREAL VSOBB3::SquaredDistance(const Rectangle3& Rectangle, VSREAL OBBParameter[3],
...
/*----------------------------------------------------------------*/
VSREAL VSOBB3::SquaredDistance(const Ray3& Ray, VSREAL fOBBParameter[3], VSREAL& fRayParameter) const
{
	return Ray.SquaredDistance(*this, fRayParameter, fOBBParameter);
}
/*----------------------------------------------------------------*/
VSREAL VSOBB3::SquaredDistance(const Segment3& Segment, VSREAL fOBBParameter[3], VSREAL& fSegmentParameter) const
{
	return Segment.SquaredDistance(*this, fSegmentParameter, fOBBParameter);
}
/*----------------------------------------------------------------*/
VSREAL VSOBB3::Distance(const Sphere3& Sphere, VSREAL fOBBParameter[3], Matrix::Math::VSVector3& SpherePoint) const
{
	return Sphere.Distance(*this, SpherePoint, fOBBParameter);
}
/*----------------------------------------------------------------*/
VSREAL VSOBB3::Distance(const Plane3& Plane, Matrix::Math::VSVector3& OBBPoint, Matrix::Math::VSVector3& PlanePoint) const
{
	return Plane.Distance(*this, PlanePoint, OBBPoint);
}
/*----------------------------------------------------------------*/
VSREAL VSOBB3::SquaredDistance(const Polygon3& Polygon,
