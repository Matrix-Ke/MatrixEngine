...
/*----------------------------------------------------------------*/
VSREAL VSVector3::SquaredDistance(const Line3& Line, VSREAL& fLineParameter) const
{
	return Line.SquaredDistance(*this, fLineParameter);
}
/*----------------------------------------------------------------*/
VSREAL VSVector3::SquaredDistance(const Ray3& Ray, VSREAL& fRayParameter) const
{
	return Ray.SquaredDistance(*this, fRayParameter);
}
/*----------------------------------------------------------------*/
VSREAL VSVector3::SquaredDistance(const Segment3& Segment, VSREAL& fSegmentParameter) const
{
...
/*----------------------------------------------------------------*/
VSREAL VSVector3::SquaredDistance(const Rectangle3& Rectangle, VSREAL fRectangleParameter[2]) const
{
...
/*----------------------------------------------------------------*/
VSREAL VSVector3::Distance(const Sphere3& Sphere, VSVector3& SpherePoint) const
{
	return Sphere.Distance(*this, SpherePoint);
}
/*----------------------------------------------------------------*/
VSREAL VSVector3::Distance(const Plane3& Plane, VSVector3& PlanePoint) const
{
	return Plane.Distance(*this, PlanePoint);
}
/*----------------------------------------------------------------*/
VSREAL VSVector3::SquaredDistance(const AABB3& AABB, VSREAL fAABBParameter[3]) const
{
	return AABB.SquaredDistance(*this, fAABBParameter);
}
/*----------------------------------------------------------------*/
VSREAL VSVector3::SquaredDistance(const Polygon3& Polygon, int& IndexTriangle, VSREAL fTriangleParameter[3]) const
{
