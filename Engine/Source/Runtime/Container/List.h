...
namespace Matrix
{
    namespace Container
    {
        ...
        class MXList : public MContainer<ListElement<T>, MXMemManagerClass>
        {
        public:
        ...
        MXList<T, MXMemManagerClass>::~MXList()
        {
            Clear();
        }

        template <class T, class MXMemManagerClass>
        MXList<T, MXMemManagerClass>::MXList(bool bUnique)
        {
            m_pHead = NULL;
            m_pTail = NULL;
            m_bUnique = bUnique;
        ...
        template <class T, class MXMemManagerClass>
        void MXList<T, MXMemManagerClass>::Clear()
        {
        ...
        template <class T, class MXMemManagerClass>
        unsigned int MXList<T, MXMemManagerClass>::GetNum() const
        {
            return m_uiNum;
        }
        template <class T, class MXMemManagerClass>
        void MXList<T, MXMemManagerClass>::operator=(const MXList &Queue)
        {
        ...
        template <class T, class MXMemManagerClass>
        void MXList<T, MXMemManagerClass>::AddElement(const T &Element)
        {
            if (m_bUnique)
            {
                if (Has(Element))
        ...
        template <class T, class MXMemManagerClass>
        bool MXList<T, MXMemManagerClass>::GetTail(T &Element)
        {
            if (!m_pTail)
            {
                return false;
        ...
        template <class T, class MXMemManagerClass>
        bool MXList<T, MXMemManagerClass>::GetAndEraseTail(T &Element)
        {
            if (!m_pTail)
            {
                return false;
        ...
        template <class T, class MXMemManagerClass>
        bool MXList<T, MXMemManagerClass>::Erase(const T &Element)
        {
            ListElement<T> *pTemp = m_pHead;
            bool bFind = false;
            while (pTemp)
        ...
        template <class T, class MXMemManagerClass>
        bool MXList<T, MXMemManagerClass>::Has(const T &Element) const
        {
            return (Find(Element) != NULL);
        }
        template <class T, class MXMemManagerClass>
        const ListElement<T> *MXList<T, MXMemManagerClass>::Find(const T &Element) const
        {
            ListElement<T> *pTemp = m_pHead;
            while (pTemp)
            {
        ...
        template <class T, class MXMemManagerClass>
        const T *MXList<T, MXMemManagerClass>::FindElement(const T &Element) const
        {
            ListElement<T> *pTemp = m_pHead;
            while (pTemp)
            {
