...
namespace Matrix
{
    namespace Container
    {
        ...
        public:
            ...
            MXBinaryTreeNode<T> *m_pParent;
            MXBinaryTreeNode<T> *m_pLeft;
            MXBinaryTreeNode<T> *m_pRight;
        };
        template <class T, class MXMemManagerClass = DefaultContainerMemoryAllocator>
        class MXDeleteProcess : public MContainer<MXBinaryTreeNode<T>, MXMemManagerClass>
        {
        public:
            MXDeleteProcess()
            {
            ...
            ~MXDeleteProcess() {}
            void operator()(MXBinaryTreeNode<T> *TreeNode)
            {
                Delete(TreeNode, 1);
            }
        };
        template <class T, class MXMemManagerClass = DefaultContainerMemoryAllocator>
        class MXBinaryTree : public MContainer<MXBinaryTreeNode<T>, MXMemManagerClass>
        {
        public:
            MXBinaryTree()
            {
            ...
            {
                MXBinaryTreeNode<T> *pCurrentNode = m_pRoot;

                if (m_pRoot == NULL)
                {
                    MXBinaryTreeNode<T> *pElem = New(1);
                    MX_NEW(pElem)
                    MXBinaryTreeNode<T>();
            ...
            {
                MXBinaryTreeNode<T> *pNode = (MXBinaryTreeNode<T> *)Find(Element);
                if (!pNode)
                    return false;
            ...
            {
                MXBinaryTreeNode<T> *pCurNode = m_pRoot;
                while (pCurNode != NULL)
                {
        ...
        protected:
            void Clear()
            {
                MXDeleteProcess<T, MXMemManagerClass> t;
                PostProcess(t);
                m_pRoot = NULL;
                m_uiNodeNum = 0;
            }
            ...
            void RemoveNotFull(MXBinaryTreeNode<T> *pNode)
            {
                MXBinaryTreeNode<T> *pChildNode = NULL;
            ...
            MXBinaryTreeNode<T> *FindLargestNode(MXBinaryTreeNode<T> *pStartNode)
            {
                MXBinaryTreeNode<T> *pNode = pStartNode;
            ...
            void RemoveFull(MXBinaryTreeNode<T> *pNode)
            {
                MXBinaryTreeNode<T> *pLargestNode = FindLargestNode(pNode->m_pLeft);
