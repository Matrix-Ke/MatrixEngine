...
namespace Matrix
{
    namespace Container
    {
        ...
        class MXQueue : public MContainer<QueueElement<T>, MXMemManagerClass>
        {
        public:
            MXQueue(bool bUnique = false);
            ~MXQueue();

            void operator=(const MXQueue &Queue);
        ...
        MXQueue<T, MXMemManagerClass>::~MXQueue()
        {
            Clear();
        }

        template <class T, class MXMemManagerClass>
        MXQueue<T, MXMemManagerClass>::MXQueue(bool bUnique)
        {
            m_pHead = NULL;
            m_pTail = NULL;
            m_bUnique = bUnique;
        ...
        template <class T, class MXMemManagerClass>
        void MXQueue<T, MXMemManagerClass>::Clear()
        {
        ...
        template <class T, class MXMemManagerClass>
        unsigned int MXQueue<T, MXMemManagerClass>::GetNum() const
        {
            return m_uiNum;
        }
        template <class T, class MXMemManagerClass>
        void MXQueue<T, MXMemManagerClass>::operator=(const MXQueue &Queue)
        {
        ...
        template <class T, class MXMemManagerClass>
        void MXQueue<T, MXMemManagerClass>::Enqueue(const T &Element)
        {
            if (m_bUnique)
            {
                if (Has(Element))
        ...
        template <class T, class MXMemManagerClass>
        bool MXQueue<T, MXMemManagerClass>::GetTop(T &Element)
        {
            if (!m_pTail)
            {
                return false;
        ...
        template <class T, class MXMemManagerClass>
        bool MXQueue<T, MXMemManagerClass>::Dequeue(T &Element)
        {
            if (!m_pTail)
            {
                return false;
        ...
        template <class T, class MXMemManagerClass>
        void MXQueue<T, MXMemManagerClass>::Erase(const T &Element)
        {
            QueueElement<T> *pTemp = m_pHead;
            while (pTemp)
            {
        ...
        template <class T, class MXMemManagerClass>
        bool MXQueue<T, MXMemManagerClass>::Has(const T &Element)
        {
            QueueElement<T> *pTemp = m_pHead;
            while (pTemp)
            {
