...
namespace Matrix
{
    namespace Container
    {
        template <class KEY, class VALUE, class MXMemManagerClass = DefaultContainerMemoryAllocator>
        class MXMap : public MContainer<MapElement<KEY, VALUE>, MXMemManagerClass>
        {
        public:
            enum
            {
            ...
            MXMap(unsigned int uiGrowBy = DEFAULT_GROWBY);
            ~MXMap();

            void SetBufferNum(unsigned int uiBufferNum);

            void operator=(const MXMap<KEY, VALUE, MXMemManagerClass> &Map);
            ...
            void AddElement(const MXMap<KEY1, VALUE1, MXMemManagerClass1> &Map, unsigned int uiBegin, unsigned int uiEnd);
        ...
        template <class KEY, class VALUE, class MXMemManagerClass = DefaultContainerMemoryAllocator>
        class MXMapOrder : public MXMap<KEY, VALUE, MXMemManagerClass>
        {
        public:
