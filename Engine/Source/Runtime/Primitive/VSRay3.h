...
namespace Matrix
{
	...
	{
		//射线
		class  MATRIX_PRIMITIVE_API VSRay3 :public VSLine3
		{
		public:

			VSRay3();
			VSRay3(const Matrix::Math::VSVector3& Orig, const Matrix::Math::VSVector3& Dir);
			~VSRay3();
			bool GetParameter(const Matrix::Math::VSVector3& Point, VSREAL& fRayParameter)const;
			void Transform(const VSRay3& Ray, const Matrix::Math::VSMatrix3X3W& Mat);
			/************************inline***************************************/
			inline Matrix::Math::VSVector3 GetParameterPoint(VSREAL fRayParameter)const;
			...
			//	//射线和球的距离
			//	VSREAL Distance(const VSSphere3& Sphere, VSREAL& fRayParameter, Matrix::Math::VSVector3& SpherePoint)const;
			//	//射线和平面距离
			//	VSREAL Distance(const VSPlane3& Plane, Matrix::Math::VSVector3& RayPoint, Matrix::Math::VSVector3& PlanePoint)const;
			//	//射线和AABB距离
