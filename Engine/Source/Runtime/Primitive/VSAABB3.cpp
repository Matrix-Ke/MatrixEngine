...
const Matrix::Math::VSVector3 VSAABB3::m_A[3] = { Matrix::Math::VSVector3(1.0f,0.0f,0.0f),Matrix::Math::VSVector3(0.0f,1.0f,0.0f),Matrix::Math::VSVector3(0.0f,0.0f,1.0f) };
/*----------------------------------------------------------------*/
VSAABB3::VSAABB3()
{
...
/*----------------------------------------------------------------*/
VSAABB3::VSAABB3(const Matrix::Math::VSVector3& Max, const Matrix::Math::VSVector3& Min)
{
	Set(Max, Min);
}
/*----------------------------------------------------------------*/
VSAABB3::VSAABB3(const Matrix::Math::VSVector3& Center, VSREAL fA0, VSREAL fA1, VSREAL fA2)
{
	Set(Center, fA0, fA1, fA2);
}
/*----------------------------------------------------------------*/
VSAABB3::VSAABB3(const Matrix::Math::VSVector3& Center, VSREAL fA[3])
{
	Set(Center, fA);
}
/*----------------------------------------------------------------*/
...
/*----------------------------------------------------------------*/
void VSAABB3::GetPoint(Matrix::Math::VSVector3 Point[8])const
{
...
/*----------------------------------------------------------------*/
bool VSAABB3::GetParameter(const Matrix::Math::VSVector3& Point, VSREAL fAABBParameter[3])const
{
	for (int i = 0; i < 3; i++)
	{
...
void VSAABB3::Transform(const VSAABB3& AABB,
	const Matrix::Math::VSMatrix3X3W& m, bool bHasProject)
{
	...
	else
	{
		...
		m_Max = Matrix::Math::VSVector3(-VSMAX_REAL, -VSMAX_REAL, -VSMAX_REAL);
		m_Min = Matrix::Math::VSVector3(VSMAX_REAL, VSMAX_REAL, VSMAX_REAL);
		for (unsigned int i = 0; i < 8; i++)
		{
			Matrix::Math::VSVector3 New = Point[i] * m;
...
/*----------------------------------------------------------------*/
VSAABB3 VSAABB3::MergeAABB(const VSAABB3& AABB)const
{
	VSAABB3 Temp;
	Temp.m_Max = m_Max;
	Temp.m_Min = m_Min;
...
/*----------------------------------------------------------------*/
void VSAABB3::CreateAABB(const Matrix::Math::VSVector3* const pPointArray, unsigned int uiPointNum)
{
	...
	Matrix::Math::VSVector3 Temp = (m_Max - m_Min) / 2.0f;
