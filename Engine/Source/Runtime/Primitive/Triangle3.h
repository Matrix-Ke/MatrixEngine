...
namespace Matrix
{
    ...
    {
        class VSOBB3;
        class MATRIX_PRIMITIVE_API VSTriangle3 : public VSPlane3
        {
        private:
            Matrix::Math::VSVector3 m_V[3];

        public:
            VSTriangle3();
            ~VSTriangle3();
            VSTriangle3(const Matrix::Math::VSVector3 &P0, const Matrix::Math::VSVector3 &P1, const Matrix::Math::VSVector3 &P2);
            VSTriangle3(const Matrix::Math::VSVector3 Point[3]);
            bool GetParameter(const Matrix::Math::VSVector3 &Point, VSREAL fTriangleParameter[3]) const;
            void Transform(const VSTriangle3 &Triangle, const Matrix::Math::VSMatrix3X3W &Mat);
            /*************************************inline************************************************/

            inline void Set(const Matrix::Math::VSVector3 &P1, const Matrix::Math::VSVector3 &P2, const Matrix::Math::VSVector3 &P3);
            inline void Set(const Matrix::Math::VSVector3 Point[3]);
            inline void GetPoint(Matrix::Math::VSVector3 Point[3]) const;
            inline Matrix::Math::VSVector3 GetParameterPoint(VSREAL fTriangleParameter[3]) const;
            inline Matrix::Math::VSVector3 GetParameterPoint(VSREAL fTriangleParameter0,
                                                             VSREAL fTriangleParameter1, VSREAL fTriangleParameter2) const;

            ///*************************************距离************************************************/
            ////点和三角形距离
            // VSREAL SquaredDistance(const Matrix::Math::VSVector3& Point, VSREAL fTriangleParameter[3])const;
            ////三角形和三角形距离
            ...
            ////三角形和球的距离
            // VSREAL Distance(const VSSphere3& Sphere, VSREAL fTriangleParameter[3], Matrix::Math::VSVector3& SpherePoint)const;

            ////平面和三角形距离
            // VSREAL Distance(const VSPlane3& Plane, Matrix::Math::VSVector3& TrianglePoint, Matrix::Math::VSVector3& PlanePoint)const;
            ////三角形和AABB距离
