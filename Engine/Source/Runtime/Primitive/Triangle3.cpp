...
/*----------------------------------------------------------------*/
VSTriangle3::VSTriangle3(const Matrix::Math::VSVector3 &P0, const Matrix::Math::VSVector3 &P1, const Matrix::Math::VSVector3 &P2)
{
    Set(P0, P1, P2);
}
/*----------------------------------------------------------------*/
VSTriangle3::VSTriangle3(const Matrix::Math::VSVector3 Point[3])
{
    Set(Point);
}
/*----------------------------------------------------------------*/
bool VSTriangle3::GetParameter(const Matrix::Math::VSVector3 &Point, VSREAL fTriangleParameter[3]) const
{
    Matrix::Math::VSVector3 v01, v02, v0p;
    Matrix::Math::VSVector3 vp1, vp2;
    v01 = m_V[1] - m_V[0];
    v02 = m_V[2] - m_V[0];
    v0p = Point - m_V[0];
    vp1 = m_V[1] - Point;
...
void VSTriangle3::Transform(const VSTriangle3 &Triangle, const Matrix::Math::VSMatrix3X3W &Mat)
{
