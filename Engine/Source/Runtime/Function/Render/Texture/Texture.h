    ...
    public:
        ...
        inline bool IsHasAlpha() const
        {
            if (m_uiFormatType == VSRenderer::SFT_A8R8G8B8 ||
                m_uiFormatType == VSRenderer::SFT_A16B16G16R16F || m_uiFormatType == VSRenderer::SFT_A32B32G32R32F || m_uiFormatType == VSRenderer::SFT_BC2 || m_uiFormatType == VSRenderer::SFT_BC3)
            {
                return true;
            }
            return false;
...
#include "VSTexture.inl"
    ...
    class MATRIX_FUNCTION_API VSTextureCache : public VSCacheResource
    {
    public:
