...
unsigned char *VSTexture::GetBuffer(unsigned int uiLevel, unsigned int uiFace) const
{
    if (uiLevel < m_uiMipLevel && uiFace < m_uiArraySize)
    {
        ...
        if (IsCompress())
        {
            return m_DataBufferArray[uiLevel].GetBuffer() + VSRenderer::ms_pRenderer->GetTextureCompressLen(GetWidth(uiLevel)) * VSRenderer::ms_pRenderer->GetTextureCompressLen(GetHeight(uiLevel)) * uiFace * VSRenderer::GetBytesPerPixel(m_uiFormatType);
        }
        else
        {
...
unsigned int VSTexture::GetByteSize(unsigned int uiLevel) const
{
    ...
    if (IsCompress())
    {
        return VSRenderer::GetBytesPerPixel(m_uiFormatType) * VSRenderer::ms_pRenderer->GetTextureCompressLen(GetWidth(uiLevel)) * VSRenderer::ms_pRenderer->GetTextureCompressLen(GetHeight(uiLevel)) * VSRenderer::ms_pRenderer->GetTextureCompressLen(GetLength(uiLevel));
    }
...
unsigned int VSTexture::GetMemPitch(unsigned int uiLevel) const
{
    ...
    if (IsCompress())
    {
        return VSRenderer::GetBytesPerPixel(m_uiFormatType) * VSRenderer::ms_pRenderer->GetTextureCompressLen(GetWidth(uiLevel));
    }
...
unsigned int VSTexture::GetMemSlicePitch(unsigned int uiLevel) const
{
    ...
    if (IsCompress())
    {
        return VSRenderer::GetBytesPerPixel(m_uiFormatType) * VSRenderer::ms_pRenderer->GetTextureCompressLen(GetWidth(uiLevel)) * VSRenderer::ms_pRenderer->GetTextureCompressLen(GetHeight(uiLevel));
    }
