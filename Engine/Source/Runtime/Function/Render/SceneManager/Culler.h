...
namespace Matrix
{
	...
	*/
	...
	class MATRIX_FUNCTION_API VSCuller : public VSMemObject
	{
	public:
		enum //CULLER TYPE
		{
...
#include "VSCuller.inl"
	class VSLocalLight;
	class MATRIX_FUNCTION_API VSShadowCuller : public VSCuller
	{
	public:
		// use light Camera
		VSShadowCuller();
	...
	class MATRIX_FUNCTION_API VSVolumeShadowMapCuller : public VSShadowCuller
	{
	...
	class MATRIX_FUNCTION_API VSDirShadowMapCuller : public VSShadowCuller
	{
	public:
