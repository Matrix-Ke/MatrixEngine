...
void VSCuller::CollectDynamicInstance(Container::MArray<VSRenderContext> &inContext)
{
    ...
    while (uiEndIndex < inContext.GetNum())
    {
        ...
        if (CanInstance && pIndexMaterial == pTempMaterial && pTempMeshData == pIndexMeshData && (pIndexMeshNode->GetDrawInstance() && pTempMeshNode->GetDrawInstance()) && pTempMaterial->IsLoaded())
        {
