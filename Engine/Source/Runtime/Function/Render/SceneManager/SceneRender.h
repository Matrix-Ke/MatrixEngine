...
namespace Matrix
{
    ...
    class MATRIX_FUNCTION_API VSSceneRenderInterface : public VSReference, public VSMemObject
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSSceneRender : public VSSceneRenderInterface
    {
    public:
        VSSceneRender();
    ...
    class MATRIX_FUNCTION_API VSOcclusionQuerySceneRender : public VSSceneRender
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSMaterialSceneRender : public VSSceneRender
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSDebugDrawSceneRender : public VSSceneRender
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSNormalDepthSceneRender : public VSSceneRender
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSPreZSceneRender : public VSSceneRender
    {
    public:
        VSPreZSceneRender();
    ...
    class MATRIX_FUNCTION_API VSPostEffectSceneRender : public VSSceneRenderInterface
    {
    protected:
    ...
    class MATRIX_FUNCTION_API VSCommonPESceneRender : public VSPostEffectSceneRender
    {
    protected:
    ...
    class MATRIX_FUNCTION_API VSCombinePostEffectSceneRender : public VSCommonPESceneRender
    {
    public:
    ...
    // 	class MATRIX_FUNCTION_API VSPESSRSceneRender : public VSPostEffectSceneRender
    // 	{
    //
    // 	public:
    // 		VSPESSRSceneRender();
    ...
    class MATRIX_FUNCTION_API VSPEMaterialSceneRender : public VSCommonPESceneRender
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSPEVolumeShadowMapSceneRender : public VSPostEffectSceneRender
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSShadowMapSceneRender : public VSSceneRender
    {
    public:
        enum //
        {
    ...
    class MATRIX_FUNCTION_API VSLightMaterialSceneRender : public VSSceneRenderInterface
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSProjectShadowSceneRender : public VSSceneRender
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSVolumeShadowSceneRender : public VSSceneRender
    {
    public:
