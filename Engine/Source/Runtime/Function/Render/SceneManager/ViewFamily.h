...
namespace Matrix
{
    ...
    class MATRIX_FUNCTION_API VSForwardHighEffectSceneRenderMethod : public VSSceneRenderMethod
    {
        // RTTI
        DECLARE_RTTI;
        DECLARE_INITIAL
    ...
    class MATRIX_FUNCTION_API VSForwardEffectSceneRenderMethod : public VSSceneRenderMethod
    {
        // RTTI
        DECLARE_RTTI;
        DECLARE_INITIAL
    ...
    class MATRIX_FUNCTION_API VSSimpleForwardEffectSceneRenderMethod : public VSSceneRenderMethod
    {
        // RTTI
        DECLARE_RTTI;
        DECLARE_INITIAL
    ...
    class MATRIX_FUNCTION_API VSWindowViewFamily : public VSViewFamily
    {
        // RTTI
        DECLARE_RTTI;
    ...
    class MATRIX_FUNCTION_API VSCaptureViewFamily : public VSViewFamily
    {
        // RTTI
        DECLARE_RTTI;
    ...
    class MATRIX_FUNCTION_API VSCubCaptureViewFamily : public VSCaptureViewFamily
    {
        // RTTI
        DECLARE_RTTI;
    ...
    class MATRIX_FUNCTION_API VS2DCaptureViewFamily : public VSCaptureViewFamily
    {
        // RTTI
        DECLARE_RTTI;
