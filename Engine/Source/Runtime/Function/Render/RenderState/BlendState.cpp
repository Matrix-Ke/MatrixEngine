...
VSPointer<VSBlendState> VSBlendState::ms_Default;
...
bool VSBlendState::InitialDefaultState()
{
    ...
    ms_Default = VSResourceManager::CreateBlendState(BlendDesc);
    if (!ms_Default)
        return 0;
    return 1;
}
...
// REGISTER_PROPERTY(fBlendFactor[0], BlendColor0, VSProperty::F_SAVE_LOAD_CLONE)
// REGISTER_PROPERTY(fBlendFactor[1], BlendColor1, VSProperty::F_SAVE_LOAD_CLONE)
// REGISTER_PROPERTY(fBlendFactor[2], BlendColor2, VSProperty::F_SAVE_LOAD_CLONE)
// REGISTER_PROPERTY(fBlendFactor[3], BlendColor3, VSProperty::F_SAVE_LOAD_CLONE)
