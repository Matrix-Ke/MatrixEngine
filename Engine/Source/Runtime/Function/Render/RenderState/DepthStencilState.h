...
namespace Matrix
{
    ...
    class MATRIX_FUNCTION_API VSDepthStencilState : public VSBind
    {
        // PRIORITY
    ...
    protected:
        static VSPointer<VSDepthStencilState> ms_Default;
    ...
    public:
        inline const VSDepthStencilDesc &GetDepthStencilDesc() const
        {
