...
bool VSTwoParamAnimBlend::ComputeOutBoneMatrix(double dAppTime)
{
    ...
    m_bHaveRootMotion = pAnimBaseFunction1->m_bHaveRootMotion | pAnimBaseFunction2->m_bHaveRootMotion | pAnimBaseFunction3->m_bHaveRootMotion | pAnimBaseFunction4->m_bHaveRootMotion;
                                          ...
                                          VSREAL fWeight1, VSREAL fWeight2)
{
    ...
    pOut->m_bHaveRootMotion = pAnimFunction1->m_bHaveRootMotion | pAnimFunction2->m_bHaveRootMotion | pAnimFunction3->m_bHaveRootMotion | pAnimFunction4->m_bHaveRootMotion;
