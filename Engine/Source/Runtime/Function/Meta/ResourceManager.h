...
//			Container::MArray<TextureBindInfoType>& TextureBindInfo, Container::MArray<VSUnorderAccess*>& UAArray, bool CPURead = false);
...
//			if (pOutputResource)
//			{
//				MATRIX_ENGINE_ASSERT(pOutputResource->m_bUsed == true);
...
//
//	protected:
//		static Core::MSynchronize ms_NameCri;
...
//
//		static Container::MArray<VSObject*> ms_pRootObject;
//		static Container::MArrayOrder<VSObject*> ms_pGCObject;
//
//	public:
...
//		static void AddCanGCObject(Container::MArray<VSObject*>& CanGCObject);
//
//	public:
...
//		T* pOutData, unsigned int uiChannel)
//	{
//		MATRIX_ENGINE_ASSERT(pInData && pOutData);
//		if (!pInData || !pOutData)
//		{
//			return false;
//		}
