...
//{
//	MATRIX_ENGINE_ASSERT(pChild && !pChild->m_pParentNode);
...
//Container::MArray<VSProfilerNode*> VSProfiler::m_pRoot;
...
//	{
//		if (GetProfilerNode()[i]->m_ParentName == Container::MString::ms_StringNULL)
//		{
...
//}
//void VSProfiler::GetProfilerNameString(const Container::MString& Name, unsigned int uiLayer, Container::MString& OutString)
//{
...
//{
//	Container::MString Out;
//	VSProfiler::GetProfilerNameString(m_Name, uiLayer, Out);
//	Out += _T(":%fms");
//	VSRenderer::ms_pRenderer->DrawText(0, VSProfiler::ms_uiCurCount * 20, DWCOLORABGR(255, 0, 255, 0), Out.GetBuffer(), m_fProfilerTime);
//}
//
...
//	VSProfiler::GetProfilerNameString(m_Name, uiLayer, Out);
//	Out += _T(":%d");
//	VSRenderer::ms_pRenderer->DrawText(0, VSProfiler::ms_uiCurCount * 20, DWCOLORABGR(255, 255, 255, 255), Out.GetBuffer(), m_uiCounter);
//}
...
//	m_uiCounter = 0;
//}
//VSOnlyTimeProfilerNode::VSProfilerNodeOnlyTImer::VSProfilerNodeOnlyTImer(VSOnlyTimeProfilerNode* pProfilerNode, VSREAL fProfilerTime)
//{
...
//	VSProfiler::GetProfilerNameString(m_Name, uiLayer, Out);
//	Out += _T(":%f");
//	VSRenderer::ms_pRenderer->DrawText(0, VSProfiler::ms_uiCurCount * 20, DWCOLORABGR(255, 255, 255, 0), Out.GetBuffer(), m_fProfilerTime);
//}