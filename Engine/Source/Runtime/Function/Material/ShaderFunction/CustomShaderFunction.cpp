...
bool VSCustomShaderFunction::IsValidNodeToThis(VSShaderFunction *pShaderFunction, MaterialShaderPara &MSPara)
{
    ...
    if (pShaderFunction->GetType().IsSameType(VSViewNormal::ms_Type) || pShaderFunction->GetType().IsSameType(VSViewPos::ms_Type) || pShaderFunction->GetType().IsSameType(VSViewWorldDir::ms_Type) || pShaderFunction->GetType().IsSameType(VSProjectPos::ms_Type) || pShaderFunction->GetType().IsSameType(VSLightDir::ms_Type) || pShaderFunction->GetType().IsSameType(VSLightColor::ms_Type) || pShaderFunction->GetType().IsSameType(VSLightSpecular::ms_Type))
    {
