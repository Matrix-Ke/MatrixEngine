...
bool VSShaderMainFunction::IsValidNodeToThis(VSShaderFunction *pShaderFunction, MaterialShaderPara &MSPara)
{
    ...
    if (pShaderFunction->GetType().IsSameType(VSViewNormal::ms_Type) || pShaderFunction->GetType().IsSameType(VSViewPos::ms_Type) || pShaderFunction->GetType().IsSameType(VSViewWorldDir::ms_Type) || pShaderFunction->GetType().IsSameType(VSProjectPos::ms_Type))
    {
