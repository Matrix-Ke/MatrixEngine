...
namespace Matrix
{
    ...
    public:
        ...
        MATRIX_FUNCTION_API friend bool operator>(const MaterialCustomPara &Para1, const MaterialCustomPara &Para2)
        {
    ...
    class MATRIX_FUNCTION_API CustomFloatValue : public MaterialCustomPara
    {
    public:
        DECLARE_RTTI;
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSCustomCSMaterial : public VSCustomMaterialInterface
    {
        // RTTI
        DECLARE_RTTI;
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSCustomMaterial : public VSCustomMaterialInterface
    {
        // RTTI
        DECLARE_RTTI;
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSMaterialOnlyTexture : public VSMaterial
    {
    protected:
    ...
    class MATRIX_FUNCTION_API VSMaterialTextureAndNormal : public VSMaterial
    {
    protected:
    ...
    class MATRIX_FUNCTION_API VSMaterialInstanceTest : public VSMaterial
    {
    protected:
    ...
    class MATRIX_FUNCTION_API VSMaterialOnlyEmissive : public VSMaterial
    {
    protected:
    ...
    class MATRIX_FUNCTION_API VSMaterialNoLight : public VSMaterial
    {
    protected:
        VSMaterialNoLight();
    ...
    class MATRIX_FUNCTION_API VSMaterialOrenNayar : public VSMaterial
    {
    protected:
        VSMaterialOrenNayar();
    ...
    class MATRIX_FUNCTION_API VSMaterialPhone : public VSMaterial
    {
    protected:
        VSMaterialPhone();
    ...
    class MATRIX_FUNCTION_API VSMaterialPhoneTwoPass : public VSMaterial
    {
    protected:
    ...
    class MATRIX_FUNCTION_API VSMaterialCustom : public VSMaterial
    {
    protected:
        VSMaterialCustom();
    ...
    class MATRIX_FUNCTION_API VSLightMaterial : public VSMaterial
    {
    protected:
        VSLightMaterial();
    ...
    class MATRIX_FUNCTION_API VSPostEffectMaterial : public VSMaterial
    {
    protected:
    ...
    class MATRIX_FUNCTION_API VSMaterialPhoneWolrdOffset : public VSMaterial
    {
    protected:
    ...
    class MATRIX_FUNCTION_API VSMaterialTessellation : public VSMaterial
    {
    protected:
