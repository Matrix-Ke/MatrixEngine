...
namespace Matrix
{
    ...
    class MATRIX_FUNCTION_API VSLightActor : public VSActor
    {
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSDirectionLightActor : public VSLightActor
    {
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSPointLightActor : public VSLightActor
    {
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSSpotLightActor : public VSLightActor
    {
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSSkyLightActor : public VSLightActor
    {
        // RTTI
        DECLARE_RTTI;
