...
namespace Matrix
{
    ...
    class MATRIX_FUNCTION_API VSRenderThreadBuffer : public VSMemObject
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSRenderThread : public VSThread
    {
    public:
        VSRenderThread();
        ~VSRenderThread();
    ...
    class MATRIX_FUNCTION_API VSRenderThreadSys : public VSMemObject
    {
    public:
        VSRenderThreadSys();
        ~VSRenderThreadSys();
