...
namespace Matrix
{
    ...
    class MATRIX_FUNCTION_API VSConstantBuffer : public VSMemObject
    {
    public:
        enum
        {
...
#define DECLARE_UNIQUE_THREAD_COMMAND_ONEPARAMETER(TypeName, ParamType1, ParamName1, Code) \
    ...
    public:                                                                                \
        ...
        TypeName(const _ParamType1 &In##ParamName1) : ParamName1(In##ParamName1)           \
        {                                                                                  \
        }                                                                                  \
        ~TypeName()                                                                        \
        {                                                                                  \
...
#define DECLARE_UNIQUE_THREAD_COMMAND_TWOPARAMETER(TypeName, ParamType1, ParamName1, ParamType2, ParamName2, Code)   \
    ...
    public:                                                                                                          \
        ...
        TypeName(const _ParamType1 &In##ParamName1, const _ParamType2 &In##ParamName2) : ParamName1(In##ParamName1), \
...
#define DECLARE_UNIQUE_THREAD_COMMAND_THREEPARAMETER(TypeName, ParamType1, ParamName1, ParamType2, ParamName2, ParamType3, ParamName3, Code)            \
    ...
    public:                                                                                                                                             \
        ...
        TypeName(const _ParamType1 &In##ParamName1, const _ParamType2 &In##ParamName2, const _ParamType3 &In##ParamName3) : ParamName1(In##ParamName1), \
                                                                                                                            ParamName2(In##ParamName2), \
...
#define DECLARE_UNIQUE_THREAD_COMMAND_FOURPARAMETER(TypeName, ParamType1, ParamName1, ParamType2, ParamName2, ParamType3, ParamName3, ParamType4, ParamName4, Code)                        \
    ...
    public:                                                                                                                                                                                \
        ...
        TypeName(const _ParamType1 &In##ParamName1, const _ParamType2 &In##ParamName2, const _ParamType3 &In##ParamName3, const _ParamType4 &In##ParamName4) : ParamName1(In##ParamName1), \
                                                                                                                                                               ParamName2(In##ParamName2), \
                                                                                                                                                               ParamName3(In##ParamName3), \
