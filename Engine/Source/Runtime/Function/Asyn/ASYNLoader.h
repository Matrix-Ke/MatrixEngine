...
namespace Matrix
{
    class MATRIX_FUNCTION_API VSAsynJob : public VSMemObject
    {
    public:
        VSAsynJob();
        virtual ~VSAsynJob() = 0;
    ...
    class MATRIX_FUNCTION_API VSFileJob : public VSAsynJob
    {
    public:
        VSFileJob();
        virtual ~VSFileJob() = 0;
    ...
    class MATRIX_FUNCTION_API VSResourceJob : public VSFileJob
    {
    public:
        enum
        {
    ...
    class MATRIX_FUNCTION_API VSCacheResourceJobBase : public VSResourceJob
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSCacheResourceJob : public VSCacheResourceJobBase<CacheType>
    {
    public:
    ...
    template <typename T, typename CacheType>
    class MATRIX_FUNCTION_API VSStreamResourceJob : public VSCacheResourceJobBase<CacheType>
    {
    public:
    ...
    template <typename T>
    class MATRIX_FUNCTION_API VSTResourceJob : public VSResourceJob
    {
    public:
    ...
    class MATRIX_FUNCTION_API VSAsynJobThread : public VSThread
    {
    public:
        VSAsynJobThread();
    ...
    class MATRIX_FUNCTION_API VSASYNLoadManager
    {
    public:
        enum MyEnum
        {
