...
void VSQuadTerrainGeometry::ComputeVariance(unsigned int uiCurLevel)
{
	...
	unsigned int uiVarianceLength = (1 << pTerrainNode->GetTessellationLevel()) + 1;
...
bool VSQuadTerrainGeometry::RecursiveComputeVariance(unsigned int uiLevel)
{
	...
	VSREAL fVariance = 0;
	unsigned int uiBias = pTerrainNode->GetTessellationLevel() - uiLevel;
	unsigned int uiVarianceLength = (1 << pTerrainNode->GetTessellationLevel()) + 1;
...
void VSQuadTerrainGeometry::UpdateOther(double dAppTime)
{
		...
		VSQuadTerrainUpdateGeometryPara,QuadTerrainUpdateGeometryPara,QuadTerrainUpdateGeometryPara,
	{
		...
		VSUSHORT_INDEX * pIndexData = (VSUSHORT_INDEX *)QuadTerrainUpdateGeometryPara.pTG->GetMeshData()->GetIndexBuffer()->Lock();
		...
		unsigned int uiBias = QuadTerrainUpdateGeometryPara.uiTessellationLevel - QuadTerrainUpdateGeometryPara.m_uiCurLevel;
		unsigned int uiVarianceLength = (1 << QuadTerrainUpdateGeometryPara.uiTessellationLevel) + 1;
