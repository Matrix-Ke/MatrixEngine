...
namespace Matrix
{
    ...
    class VSIndexBuffer;
    class MATRIX_FUNCTION_API VSDynamicBufferGeometry : public VSGeometry
    {
        // RTTI
        DECLARE_RTTI;
    ...
    class MATRIX_FUNCTION_API VSDVGeometry : public VSDynamicBufferGeometry
    {
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSDVDIGeometry : public VSDynamicBufferGeometry
    {
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSSVDIGeometry : public VSDynamicBufferGeometry
    {
        // PRIORITY
    ...
    class MATRIX_FUNCTION_API VSDVSIGeometry : public VSDynamicBufferGeometry
    {
        // PRIORITY
