...
namespace Matrix
{
    ...
    class VSOutputNode;
    class MStream;
    class MATRIX_FUNCTION_API VSPutNode : public MObject
    {
        // RTTI
        DECLARE_RTTI;
    ...
    protected:
        VSPutNode(unsigned int uiValueType, const VSUsedName &NodeName, MObject *pShaderFunction);
        VSPutNode();
        MObject *m_pOwner;
        VSUsedName m_NodeName;
        unsigned int m_uiValueType;
        inline void SetOwner(MObject *pOwner)
        {
            m_pOwner = pOwner;
        }
    ...
    class MATRIX_FUNCTION_API VSInputNode : public VSPutNode
    {
        // RTTI
        DECLARE_RTTI;
        ...
        DECLARE_INITIAL
    public:
        VSInputNode(unsigned int uiValueType, const VSUsedName &NodeName, MObject *pObject);
        virtual ~VSInputNode();
    ...
    class MATRIX_FUNCTION_API VSOutputNode : public VSPutNode
    {
        // RTTI
        DECLARE_RTTI;
        DECLARE_INITIAL
    ...
    public:
        VSOutputNode(unsigned int uiValueType, const VSUsedName &NodeName, MObject *pShaderFunction);
        virtual ~VSOutputNode();

    protected:
        VSOutputNode();
        Container::MArray<VSInputNode *> m_pInputLink;
