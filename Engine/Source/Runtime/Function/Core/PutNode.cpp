...
IMPLEMENT_RTTI_NoCreateFun(VSPutNode, MObject)
    ...
    BEGIN_ADD_PROPERTY(VSPutNode, MObject)
        REGISTER_PROPERTY(m_NodeName, NodeName, VSProperty::F_SAVE_LOAD_CLONE)
            REGISTER_PROPERTY(m_uiValueType, ValueType, VSProperty::F_SAVE_LOAD_CLONE)
                REGISTER_PROPERTY(m_pOwner, Owner, VSProperty::F_SAVE_LOAD_CLONE)
                    END_ADD_PROPERTY
    VSPutNode::VSPutNode(unsigned int uiValueType, const VSUsedName &NodeName, MObject *pObject)
{
    m_pOwner = pObject;
    m_NodeName = NodeName;
...
VSInputNode::VSInputNode(unsigned int uiValueType, const VSUsedName &NodeName, MObject *pObject)
...
VSOutputNode::VSOutputNode(unsigned int uiValueType, const VSUsedName &NodeName, MObject *pObject)
    : VSPutNode(uiValueType, NodeName, pObject)
{
