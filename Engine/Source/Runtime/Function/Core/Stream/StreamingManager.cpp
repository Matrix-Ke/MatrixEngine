...
{
	for (Container::MList<StreamElementType>::ListIterator t = m_StreamObjectList.Begin(); t != m_StreamObjectList.End(); ++t)
	{
		if (!t->bFree)
		{
...
void VSStreamingManager::GetStreamInfo(const Primitive::AABB3& WorldAABB, StreamInformation_TYPE& StreamInformation)
{
