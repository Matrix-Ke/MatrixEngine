...
MXCriticalSection gSafeOutputString;
...
void Matrix::Core::MXSynchronize::MXSafeOutputDebugString(const TCHAR *pString, ...)
{
    MXCriticalSection::Locker Temp(gSafeOutputString);
    char *pArgs;
...
{
    MXCriticalSection::Locker Temp(mCriticalSection);
